...
- `<meta name="robots">` is **noindex, nofollow** on all 19 pages (the build inherits the original's `index, follow`)
- `<link rel="canonical">` points at the **absolute url of the page it was cloned from** (19 pages)
